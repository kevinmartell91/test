...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'cache_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CacheService A AppBundle\Service\CacheService instance.
     */
    protected function getCacheServiceService()
    {
        return $this->services['cache_service'] = new \AppBundle\Service\CacheService('127.0.0.1', 6379, NULL);
    }
    ...
    /**
     * Gets the 'database_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\DatabaseService A AppBundle\Service\DatabaseService instance.
     */
    protected function getDatabaseServiceService()
    {
        return $this->services['database_service'] = new \AppBundle\Service\DatabaseService('127.0.0.1', 27017, 'easytaxi-symfony-cache');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('et');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56b4c71708bd07.12724029')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 27017,
            'database_name' => 'easytaxi-symfony-cache',
            'secret' => 'et',
